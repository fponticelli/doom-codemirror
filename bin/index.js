...
Div.__name__ = ["Div"];
Div.__super__ = doom_html_Component;
Div.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		return doom_core__$VNode_VNode_$Impl_$.el("div",null,doom_core__$VChildren_VChildren_$Impl_$.children([this.props.n]));
	}
	,__class__: Div
});
...
doom_html_Render.prototype = {
	...
	,mount: function(node,parent) {
		parent.innerHTML = "";
		var post = [];
		var n = this.generateVChildDom(node,post);
	...
	,applyVChildToNode: function(node,dom,parent,post,tryUnmount) {
		...
		case 0:
			var n = node[2];
			return this.applyToNode(n,dom,parent,post,tryUnmount);
		case 1:
			var comp = node[2];
	...
	,generateVChildDom: function(node,post) {
		...
		case 0:
			var n = node[2];
			return this.generateDom(n,post);
		case 1:
			var comp = node[2];
			comp.willMount();
	...
	,createElement: function(name,attributes,children,post) {
		...
		while(tmp1.hasNext()) {
			...
			var n = this.generateVChildDom(child,post);
			el.appendChild(n);
		}
		return el;
	}
...
var EditorContainer = function(props,children) {
	doom_html_Component.call(this,props,children);
};
EditorContainer.__name__ = ["EditorContainer"];
EditorContainer.__super__ = doom_html_Component;
EditorContainer.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		return doom_core__$VNode_VNode_$Impl_$.el("div",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor("# title","markdown"))]));
	}
	,__class__: EditorContainer
});
var Helpers = function() { };
Helpers.__name__ = ["Helpers"];
Helpers.createEditor = function(content,mode,blur) {
	return new doom_cm_CodeMirror({ blur : blur, options : { value : content, indentUnit : 2, tabSize : 2, indentWithTabs : false, lineNumbers : true, mode : mode}});
};
Helpers.getContainer = function(name) {
...
Main.mountComponent = function() {
	var comp = Helpers.createEditor("var a = 1;","javascript");
	Doom.browser.mount(doom_core_VChildImpl.Comp(comp),Helpers.getContainer("mount component"));
};
Main.buildFromComponent = function() {
	var comp = new EditorContainer({ });
	Doom.browser.mount(doom_core_VChildImpl.Comp(comp),Helpers.getContainer("build from component"));
};
Main.sequence = function() {
	var comp = new Div({ n : Helpers.createEditor("var a = 1;","javascript").asNode()});
	Doom.browser.mount(doom_core_VChildImpl.Comp(comp),Helpers.getContainer("sequence"));
	comp.update({ n : doom_core_VChildImpl.Comp(Helpers.createEditor("var a = 2;","javascript"))});
	comp.update({ n : doom_core_VChildImpl.Comp(Helpers.createEditor("# title;","markdown"))});
};
Main.multiUpdate = function() {
	var comp = new Multi({ a : "# title A", b : "var v = 2;", c : "GET /some HTTP/1.1\nHost: example.com"});
	Doom.browser.mount(doom_core_VChildImpl.Comp(comp),Helpers.getContainer("multi update"));
};
Main.multiSequence = function() {
	var comp = new MultiSequence({ a : "# title A", b : "var v = 2;", c : "GET /some HTTP/1.1\nHost: example.com"});
	Doom.browser.mount(doom_core_VChildImpl.Comp(comp),Helpers.getContainer("multi sequence"));
};
Math.__name__ = ["Math"];
var Multi = function(props,children) {
	doom_html_Component.call(this,props,children);
};
Multi.__name__ = ["Multi"];
Multi.__super__ = doom_html_Component;
Multi.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		var _g = this;
		return doom_core__$VNode_VNode_$Impl_$.el("ul",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.a,"markdown",function(editor) {
			var value = editor.getValue();
			_g.update(thx_Objects.combine(_g.props,{ a : value}));
		}))]))),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.b,"javascript",function(editor1) {
			var value1 = editor1.getValue();
			_g.update(thx_Objects.combine(_g.props,{ b : value1}));
		}))]))),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.c,"http",function(editor2) {
			var value2 = editor2.getValue();
			_g.update(thx_Objects.combine(_g.props,{ c : value2}));
		}))])))]));
	}
	,__class__: Multi
});
var MultiSequence = function(props,children) {
	this.counter = 0;
	doom_html_Component.call(this,props,children);
};
MultiSequence.__name__ = ["MultiSequence"];
MultiSequence.__super__ = doom_html_Component;
MultiSequence.prototype = $extend(doom_html_Component.prototype,{
	counter: null
	,render: function() {
		var _g = this.counter++;
		switch(_g) {
	...
	,render0: function() {
		...
		return doom_core__$VNode_VNode_$Impl_$.el("ul",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.c,"http",$bind(this,this.blurC)))])))]));
	}
	,render1: function() {
		var f = $bind(this,this.update);
		var a1 = this.props;
		...
		return doom_core__$VNode_VNode_$Impl_$.el("ul",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.b,"javascript",$bind(this,this.blurB)))]))),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.c,"http",$bind(this,this.blurC)))])))]));
	}
	,render2: function() {
		return doom_core__$VNode_VNode_$Impl_$.el("ul",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.a,"markdown",$bind(this,this.blurA)))]))),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.b,"javascript",$bind(this,this.blurB)))]))),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("li",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(Helpers.createEditor(this.props.c,"http",$bind(this,this.blurC)))])))]));
	}
	,blurA: function(editor) {
		var value = editor.getValue();
		this.update(thx_Objects.combine(this.props,{ a : value}));
	}
	,blurB: function(editor) {
		var value = editor.getValue();
		this.update(thx_Objects.combine(this.props,{ b : value}));
	}
	,blurC: function(editor) {
		var value = editor.getValue();
		this.update(thx_Objects.combine(this.props,{ c : value}));
	}
	,__class__: MultiSequence
});
...
var doom_cm_CodeMirror = function(props,children) {
	doom_html_Component.call(this,props,children);
};
doom_cm_CodeMirror.__name__ = ["doom","cm","CodeMirror"];
doom_cm_CodeMirror.__super__ = doom_html_Component;
doom_cm_CodeMirror.prototype = $extend(doom_html_Component.prototype,{
	editor: null
	,events: null
	,render: function() {
		var _g = new haxe_ds_StringMap();
		var value = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("doom-codemirror");
		if(__map_reserved["class"] != null) _g.setReserved("class",value); else _g.h["class"] = value;
		return doom_core__$VNode_VNode_$Impl_$.el("div",_g,null);
	}
	,shouldRender: function() {
		return false;
	}
	,didMount: function() {
		this.editor = new CodeMirror(this.node,this.props.options);
		this.setupEvents();
		if(null != this.props.mount) this.props.mount(this.editor);
	}
	,setupEvents: function() {
		this.events = new haxe_ds_StringMap();
		var _g = 0;
		var _g1 = doom_cm_CodeMirror.eventNames;
		while(_g < _g1.length) {
			var name = _g1[_g];
			++_g;
			var f = Reflect.field(this.props,name);
			if(null == f) continue;
	...
	,clearEvents: function() {
		...
		var tmp = this.events.keys();
		while(tmp.hasNext()) {
			var name = tmp.next();
			var tmp1;
			var _this = this.events;
			if(__map_reserved[name] != null) tmp1 = _this.getReserved(name); else tmp1 = _this.h[name];
			this.editor.off(name,tmp1);
		}
	}
	,didUpdate: function() {
		this.clearEvents();
		var _g = 0;
		var _g1 = doom_cm_CodeMirror.optionNames;
		while(_g < _g1.length) {
			var field = _g1[_g];
			++_g;
			var current = this.editor.getOption(field);
			var value = Reflect.field(this.props.options,field);
			if(null == value) value = Reflect.field(CodeMirror.defaults,field);
			if(current != value) this.editor.setOption(field,value);
		}
		this.editor.setValue(this.props.options.value);
		if(null != this.props.refresh) this.props.refresh(this.editor);
		this.setupEvents();
	}
	,willUnmount: function() {
		this.clearEvents();
	}
	,__class__: doom_cm_CodeMirror
});
